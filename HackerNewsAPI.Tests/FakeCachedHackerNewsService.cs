...
{
    public class FakeCachedHackerNewsService : CachedHackerNewsService
    {
        public FakeCachedHackerNewsService()
            : base(new HackerNewsService(new HttpClient()), new MemoryCache(new MemoryCacheOptions()))
        {
        }
